...
import com.mycompany.rahafapp.BinaryTree.Node;
...
public void searchAndDisplayVolunteer(LinkedList<Volunteer> volunteers, JTable table, DefaultTableModel model) {
    ...
    if (!found) {
        JOptionPane.showMessageDialog(null, "Volunteer with name " + name + " not found.");
    }
...
DefaultTableModel tableData = new DefaultTableModel();
    ...
    tableData.addColumn("Age");
    tableData.addColumn("Gender");
    tableData.addColumn("Type");
}


public void displayVolunteers(DefaultTableModel tableData) {
    ...
    private void initComponents() {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(Vname, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(Vname, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        //Display Volureent in the table After press
...
tableData.addColumn("Gender");
tableData.addColumn("Type");
displayVolunteers(tableData);

    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       DefaultTableModel tableData = new DefaultTableModel();
        LinkedList<Volunteer> getlist = manager.getVolunteers();
tableData.addColumn("ID");
tableData.addColumn("Name");
tableData.addColumn("Age");
tableData.addColumn("Gender");
tableData.addColumn("Type");
        searchAndDisplayVolunteer(getlist,dataTable,tableData);
